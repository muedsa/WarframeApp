...
public class InvasionFragment extends Fragment {
    ...
    public InvasionFragment(){}

    public static InvasionFragment newInstance() {
        InvasionFragment fragment = new InvasionFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new InvasionAdapter(this));
